 ...
 * 
 */
.controller('ContributionsCtrl', ['$scope', '$stateParams', 'supernode', 'users', 'Upload', '$timeout', 'ModalService', 'contributions', 'contribution', 'tags', function($scope, $stateParams, supernode, users, Upload, $timeout, ModalService, contributions, contribution, tags){
  ...
  $scope.graphInit = function(graph_data){
      ...
      if($stateParams.contributionId && cy.getElementById( $stateParams.contributionId))
          $scope.highlightNode(cy.getElementById( $stateParams.contributionId));
